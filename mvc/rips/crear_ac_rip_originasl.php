...
header("Content-Disposition: attachment; filename=\"RIDEC-$nombre_archivo.txt\"");
//traer los datdos de la factura
     // $sql2 = "Select * from factura where MONTH(fecha)='mysql_datetime'";
       $sql2 = "Select * from factura $where and origen_factura=0 and estado=1 order by id_factura asc";
			  ...
			  $fecha_f=$row2['fecha'];
					...
					$grupo_cups ="";
						...
						while ($row_fac = mysql_fetch_array($result_fac)) {
                                                    ...
                                                    $datos=$id_factura.",190010880501,".$tipo_identificacion.",".$id_pacie.",".$fecha_cc.",,".$grupo_cups.",10,13,".$principal.",".$diag_1.",".$diag_3.",".$diag_3.",2,".$valor_cup.",".$valor_cuota.",".$valor_cup." \r\n";
