...
<div id="content_welcome">
    ...
    <div id="text_welcome">
        <form name="form_user" id="form_user" action="<?php echo Utils::http_ruta() ?>mvc/rips/crear_us_rip.php" method="post">
            <input type="hidden" value="<?php echo $hidden_val; ?>" id="type_acc" name="type_acc" />
