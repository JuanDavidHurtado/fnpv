...
if (isset($_REQUEST['opcion'])) {
    ...
    if ($_REQUEST['opcion'] == 1) {
        ...
        $sql = "select * from eps where id_regimen = " . $_REQUEST['id_regimen'];
        $result = $conexion->EjecutarQuery($sql);
        ...
        if ($_REQUEST['fecha'] >= $date) {
            ...
            if (!$bool_c) {
                ...
                $sql_insert_cita = "INSERT INTO `cita` 
                                    (`id_proceso`, `id_usuario`, `id_paciente`, `fecha`, `fecha_hora_inicio`, `fecha_hora_fin`,`fecha_hora_limite`, `id_sesion`) 
                                    VALUES ('" . $_REQUEST['id_proceso'] . "', '" . $_REQUEST['id_usuario'] . "', '" . $_REQUEST['id_paciente'] . "', '" . $_REQUEST['fecha'] . "', '$fecha_hora_inicio', '$fecha_hora_fin', '$fecha_hora_fin', '" . $_REQUEST['id_sesion'] . "')";
