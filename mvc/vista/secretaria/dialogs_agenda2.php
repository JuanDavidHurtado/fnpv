...
<script>
    ...
    function guardar_cita() {
        ...
        var parameters = "opcion=7&grupo_cups=" + grupo + "&id_proceso=" + id_proceso_ + "&id_usuario=" + id_usuario_ + "&id_paciente=" + object_ajax.historia + "&fecha=" + fecha_ + "&id_sesion=" + id_sesion_ + "&hora_inicio=" + hora_inicio_ + "&hora_fin=" + hora_fin_ + '&tipo_cita=' + $('#tipo_cita').val()+'&fecha_des=' + $('#fecha_des').val()+'&idAgenda='+id_agenda_;
        //alert(parameters);
        $.ajax({
            dataType: "json",
            data: parameters,
