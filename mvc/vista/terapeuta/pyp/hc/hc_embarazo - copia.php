...
<legend align="left"> <div class="arrow-c" id="close-hc_embarazo"></div> <div class="arrow-o" id="open-hc_embarazo" ></div> 
<font>Embarazo</font></legend>
...
<table border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr height="38">
	...
	<td width="95">Despues		2 semana</td>
	<td width="100">Muertos		2 semana</td>
	<td width="95">Despues		3 semana</td>
	<td width="100">Muertos		3 semena</td>
	<td width="94">Despues		4 semana</td>
	<td width="100">Muertos		4 semana</td>
	<td width="94">Despues		5 semana</td>
	<td width="100">Muertos		5 semana</td>
	<td	width="95">Edad mearquia </td>
	<td width="94">
	<td width="100">
  ...
  <tr>
  <tr height="20">
	<td height="19" width="154">abortos</td>
	<td height="130" width="140">extopicos</td>
	<td height="132" width="130">Total gestacion</td>
	<td width="20" width="132">numero de partos</td>
	<td width="21" width="130">Otros</td>
  </tr>
  
  <tr>
  <tr height="21">
   <td width="121">embarazo deseado</td>
   <td width="113">embarazo planeado<td>
   <td width="102">sindrome de HELLP</td>
...
<table border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr height="38">
	...
	<td rowspan="2" width="95">Total semanas en gestacion</td>
	<td rowspan="2" width="94">Fecha defecundacion</td>
	<td rowspan="2" width="90">Corticoides</td>
	<td rowspan="2" width="93"> antenatales</td>
...
<table border="1" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr height="20">
	...
	<td width="110"><input type="text" class="input_txt valid" id="inicio_2_11" name="inicio_2_11" value="<?php echo @$inicio_2_11; ?>" /></td>
	<td width="112"><input type="text" class="input_txt valid" id="inicio_1_12" name="inicio_1_12" value="<?php echo @$inicio_1_12; ?>" /></td>
	<td width="112"><input type?"text" class="input_txt valid" id="inicio_1_13" name="inicio_1_13" value="<?php echo @$inicio_1_13; ?>" /></td>
