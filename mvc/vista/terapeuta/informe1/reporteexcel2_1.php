...
<?php
    $conexion = new mysqli('localhost','root','sena','sids_siempre_db',3306);
	...
	//$resultado = $conexion->query($consulta);
		...
		//require_once 'lib/PHPExcel/PHPExcel.php';
                 include 'C:/xampp/htdocs/siempree/include/lib/PHPExcel/PHPExcel.php';
		...
		while ($fila = $resultado->fetch_array()) {
			$objPHPExcel->setActiveSheetIndex(0)
        		    ...
        		    ->setCellValue('C'.$i,  $fila['id_usuario'])
