...
$sql2 = "Select * from factura where 1=1 $where and estado=1 and id_proceso=54 or id_proceso=55 or id_proceso=58 or id_proceso=59 or id_proceso=60 or id_proceso=61 or id_proceso=62";
