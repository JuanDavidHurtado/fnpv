...
function guardar_medicamento() {
            ...
            var fechag_1x = $("#fechag_1x").val();
            var fechag_2x = $("#fechag_2x").val();
            var fechag_3x = $("#fechag_3x").val();
            var fechag_4x = $("#fechag_4x").val();
            var fechag_5x = $("#fechag_5x").val();
            var fechag_6x = $("#fechag_6x").val();
          ...
          var id_vinicial =<?php echo $inic; ?>;
           ...
           var parameters = "opcion=36&id_usuario="+id_usuario+"&id_proceso="+id_proceso+"&historia="+historia+"&id_vinicial="+id_vinicial+"&fechag_1x="+fechag_1x+"&fechag_2x="+fechag_2x+"&fechag_3x="+fechag_3x+"&fechag_4x="+fechag_4x+"&fechag_5x="+fechag_5x+"&fechag_6x="+fechag_6x;
...
function borrar_medicamento(valor_x) {

           var parameters = "opcion=37&valor="+valor_x
   ...
   //
    if(inputString.length == 0) {
      ...
      $('#suggestions').hide();
              ...
              var parameters = "opcion=68&queryString="+inputString;
...
<form id="fomu_formula" action="<?php echo Utils::$http_ruta ?>mvc/vista/terapeuta/formularios/guardar_formularios.php?opcion=10" method="post">
...
<div id="formula_med">
  ...
  <tr height="">
    <td colspan="5" height=""><div align="center">FORMULA MEDICA</div></td>
  </tr>
  <tr height="">
    <td height="" width="175">MEDICAMENTO</td>
    <td width="175">POSOLOGIA</td>
    <td width="175">VIA</td>
    <td width="173">CANTIDAD</td>
    <td width="276">DIAS</td>
  </tr>
  <tr height="">
    ...
    <td width="175">
     ...
     <input name="fechag_1x" type="text" id="fechag_1x" class="input_txt" onBlur="fill();" onKeyUp="lookup(this.value);" value="" size="25" onDblClick="limpiar();"/>
    ...
    <td width="175"><input type="text" class="input_txt valid" id="fechag_3x" name="fechag_3x" value="0" /></td>
    <td width="175"><input type="text" class="input_txt valid" id="fechag_4x" name="fechag_4x" value="0" /></td>
    <td width="173"><input type="text" class="input_txt valid" id="fechag_2x" name="fechag_2x" value="0" /></td>
    <td width="276"><input type="text" class="input_txt valid" id="fechag_5x" name="fechag_5x" value="0" /></td>
  </tr>
</table>
...
<input type="hidden" class=" " id="fechag_6x" name="fechag_6x" value="<?php echo $fecha_dia; ?>" />

</form>


<div id="tabla_formula">
...
<table border="0" class="data" width="500" align="center" cellpadding="0" cellspacing="0" style="font-size: <?php echo $tamfont ?>px !important">
  ...
  <tr height="">
    <td colspan="6" height=""><div align="center">FORMULA MEDICA <?php echo $fecha_dia; ?></div></td>
  </tr>
  <tr height="">
      <td height="" width="" align="center">MEDICAMENTO</td>
      <td width="" align="center">POSOLOGIA</td>
      <td width="" align="center">VIA</td>
      <td width="" align="center">CANTIDAD</td>
    <td width="" align="center">DIAS</td>
    <td width=""></td>
  </tr>

  <?php

$sql_z = "SELECT * from hc_formula_medica  where id_proceso=" . $_REQUEST['id_proceso'] . " and id_vinicial=" . $_REQUEST['id_vinicial'] . " and id_historia=" . @$_REQUEST['historia'] . " ";


$result_x12z = $conexion->EjecutarQuery($sql_z);
while ($row_x12z = mysql_fetch_array($result_x12z)) {

    echo '<tr height="">
                                    <td>' . $row_x12z['m_medicamento'] . '</td>
                                  <td>' . $row_x12z['m_posologia'] . '</td>
                                  <td>' . $row_x12z['m_via'] . '</td>
                                    <td align="center" >' . $row_x12z['m_cantidad'] . '</td>
                                    <td align="center">' . $row_x12z['m_dias'] . '</td>
                               ';
    if (isset($_REQUEST['id_cita'])) {

        echo "<td align='center'><a href='#' onclick='borrar_medicamento(" . $row_x12z['id_hc_formula_medica'] . ")'><img src='" . Utils::$http_ruta . "mvc/vista/imagenes/delete.png' width='18px' height='18px' /></a></td>";
...
<table border="0" class="data" width="500" align="center" cellpadding="0" cellspacing="0" style="font-size: <?php echo $tamfont ?>px !important">
  ...
  <?php         
$sql_z5 = "select * from hc_formula_medica  where  id_proceso=" . $_REQUEST['id_proceso'] . " and id_vinicial=" . $_REQUEST['id_vinicial'] . " and id_historia=" . @$_REQUEST['historia'] . " ";
  //echo "$sql_z5";

$result_x12z5 = $conexion->EjecutarQuery($sql_z5);
while ($row_x12z5 = mysql_fetch_array($result_x12z5)) {

    echo '<tr height="">
                                    <td>' . $row_x12z5['m_medicamento'] . '</td>
                                  <td>' . $row_x12z5['m_posologia'] . '</td>
                                  <td>' . $row_x12z5['m_via'] . '</td>
                                    <td align="center" >' . $row_x12z5['m_cantidad'] . '</td>
                                    <td align="center">' . $row_x12z5['m_dias'] . '</td>
                               ';
...
<a href='#' onClick='imprSelec4("tabla_formula_2")' >Imprimir formula</a>