...
<legend align="left"> <div class="arrow-c" id="close-fr_medicamentos"></div> <div class="arrow-o" id="open-fr_medicamentos" ></div> <font>FÓRMULA MÉDICA</font></legend>
...
<table width="812" border="0" class="data" align="center" cellpadding="0" cellspacing="0">
  <col width="83" />
  <col width="280" />
  <col width="173" />
  <tr height="19">
    <td colspan="4" height="19"><div align="center">FÓRMULA MÉDICA</div></td>
  </tr>
  <tr height="19">
    <td width="21" height="19">&nbsp;</td>
    <td width="396">MEDICAMENTO, VIAS    DOSIS E INDICACIONES </td>
    <td width="182">CANTIDAD DIAS</td>
    <td width="213">CANTIDAD NUMERO</td>
  </tr>
  <tr height="19">
    <td height="19">1</td>
    ...
    <td><input type="text" class="input_txt valid" id="fecham_1" name="fecham_1" value="<?php echo @$fecham_1; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">2</td>
    ...
    <td><input type="text" class="input_txt valid" id="fecham_2" name="fecham_2" value="<?php echo @$fecham_2; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">3</td>
    ...
    <td><input type="text" class="input_txt valid" id="fecham_3" name="fecham_3" value="<?php echo @$fecham_3; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">4</td>
    ...
    <td><input type="text" class="input_txt valid" id="fecham_4" name="fecham_4" value="<?php echo @$fecham_4; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">5</td>
    ...
    <td><input type="text" class="input_txt valid" id="fecham_5" name="fecham_5" value="<?php echo @$fecham_5; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">6</td>
    ...
    <td><input type="text" class="input_txt valid" id="fecham_6" name="fecham_6" value="<?php echo @$fecham_6; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">7</td>
    ...
    <td><input type="text" class="input_txt valid" id="fecham_7" name="fecham_7" value="<?php echo @$fecham_7; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">8</td>
    ...
    <td><input type="text" class="input_txt valid" id="fecham_8" name="fecham_8" value="<?php echo @$fecham_8; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">9</td>
    ...
    <td><input type="text" class="input_txt valid" id="fecham_9" name="fecham_9" value="<?php echo @$fecham_9; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">10</td>
    ...
    <td><input type="text" class="input_txt valid" id="fecham_10" name="fecham_10" value="<?php echo @$fecham_10; ?>" /></td>
  </tr>
</table>
