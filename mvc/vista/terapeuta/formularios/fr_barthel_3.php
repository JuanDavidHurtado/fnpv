...
`reisberg_total` = '".$_REQUEST['reisberg_total']."' WHERE `id_fr_barthel` = '".$_REQUEST['id_fr_barthel']."' ;"; 
...
//alert("DD");
        ...
        var resultado6 =parseInt(e1)+parseInt(e2)+parseInt(e3)+parseInt(e4)+parseInt(e5)+parseInt(e6)+parseInt(e7)+parseInt(e8)+parseInt(e9)+parseInt(e10)+parseInt(e11)+parseInt(e12)+parseInt(e13);
...
<td rowspan="2" width="77"><select name="reisberg_total" size="1" id="reisberg_total" onChange=" pasar_valores()">
  ...
  <p><strong>RESUMEN DE RESULTADOS</strong></p>
            <table width="818" cellpadding="0" cellspacing="0" class="data">
              ...
              <tr height="19">
                <td rowspan="2" height="38" width="178">Actividades Basicas</td>
