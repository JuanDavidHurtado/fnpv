...
echo "<h3>Homecare - Valoracion terapia Respiratoria</h3><br>";

//$path = $GLOBALS['raiz'] . 'mvc/vista/terapeuta/rehabilitacion/trespiratoria/';

include($GLOBALS['raiz'] . 'mvc/vista/terapeuta/rehabilitacion/trespiratoria/hc_respiratorio.php');
...
<br>
<a href='#' onclick='imprSelec("terapia_res", true)' class="no_print">Imprimir formulario</a>