...
$sql = "SELECT * from h2_cotidianidad WHERE `historia` = '" . $_REQUEST['historia'] . "' and `id_revaloracion` = '" . $_REQUEST['id_revaloracion'] . "' ";
...
<fieldset id="h2_cotidianidad">
    <legend align="left"> <div class="arrow-c" id="close-h2_cotidianidad"></div> <div class="arrow-o" id="open-h2_cotidianidad" ></div> <font>Valoracion terapia ocupacional neurorehabilitacion - Cotidianidad</font></legend>
