<?php
if (isset($_REQUEST['guardar_h2_patrones4']) && isset($_REQUEST['id_cita'])) {
...
`patro_obser6` = '" . $_REQUEST['patro_obser6'] . "' WHERE `id_h2_patrones` = '" . $_REQUEST['id_h2_patrones'] . "' ;";
    }
...
<script>
    ...
    $(function() {
        ...
        $("#close-h2_patrones4").click(function() {
            $("#open-h2_patrones4").show();
            $(this).hide();
            $("#content-h2_patrones4").hide('slow');
        });

        $("#open-h2_patrones4").click(function() {
            $("#close-h2_patrones4").show();
            $(this).hide();
            $("#content-h2_patrones4").show('slow');
        });

    });

</script>
<fieldset id="h2_patrones4">
    <legend align="left"> <div class="arrow-c" id="close-h2_patrones4"></div> <div class="arrow-o" id="open-h2_patrones4" ></div> <font>Valoracion terapia ocupacional neurorehabilitacion - Haptica</font></legend>
    <div id="content-h2_patrones4">
        <?php
        if (isset($_REQUEST['id_cita'])) {
            $button = '<button name="guardar_h2_patrones4" id="guardar_h2_patrones4" >Guardar</button>';
        } else {
            $readonly = " readonly='readonly' ";
        }
        ?>
        <form id="form_h2_patrones4" name="form_h2_patrones4" action="<?php echo @$action_form_h2_patrones4 ?>#h2_patrones4" method="post">
