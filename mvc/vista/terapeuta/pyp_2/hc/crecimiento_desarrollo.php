...
<table cellspacing="0" cellpadding="0" border="1">
  ...
  <tr height="19">
    ...
    <td width="228">F.RESP.</td>
    <td width="168"><input type="text" class="input_txt valid" id="sv_res_1" name="sv_res_1" value="<?php echo @$sv_res_1; ?>" /></td>
    <td width="168"><input type="text" class="input_txt valid" id="sv_res_2" name="sv_res_2" value="<?php echo @$sv_res_2; ?>" /></td>
    <td width="168"><input type="text" class="input_txt valid" id="sv_res_3" name="sv_res_3" value="<?php echo @$sv_res_3; ?>" /></td>
    <td width="168"><input type="text" class="input_txt valid" id="sv_res_4" name="sv_res_4" value="<?php echo @$sv_res_4; ?>" /></td>
  </tr>
  <tr height="19">
  ...
  <tr >
    <td colspan="2" rowspan="3" >MEDIDAS<br />
      ANTROPOMÉTRICAS</td>
    <td>PESO(G)</td>
  ...
  <tr >
    <td rowspan="4" height="115" width="224">ESTADO<br />
    NUTRICIONAL</td>
  ...
  <tr height="38">
    <td colspan="7" height="28">PARENTESCO RESPONSABLE:
