...
//traer los datdos de la factura
     // $sql2 = "Select * from factura where MONTH(fecha)='mysql_datetime'";
       $sql2 = "Select * from factura $where and estado=1";
			  ...
			  $valor_cuota = 0; ////
					...
					//traer cups
						...
						$grupo_cups = $row_fac['id_cup'];
                                                  ...
                                                  $sql_fac2 = "Select * from factura_cup where id_factura = " .$idfactura2;
                                                  $result_fac2 = $conexion->EjecutarQuery($sql_fac2);
                                                  $row_fac3 = mysql_fetch_array($result_fac);
...
if($paso_con!=1){
                ...
                echo $dat.$tabla."<tr><td colspan='9' align='right'>TOTAL</td><td align='right'>".$total_f."</td></tr><table><br><br></div></div>";
}else{
