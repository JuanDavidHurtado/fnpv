<?php
if (isset($_REQUEST['guardar_e_sistema_osteomuscular']) && isset($_REQUEST['id_cita'])) {

    if ($_REQUEST['id_e_sistema_osteomuscular'] == 'new') {

        $sql = "INSERT INTO e_sistema_osteomuscular (
`id_e_sistema_osteomuscular`,
`id_proceso`,
`id_usuario`,
`historia`,
`fuerza`,
...
'" . $_REQUEST['t200'] . "' 
    ...
    } else if ($_REQUEST['id_e_sistema_osteomuscular'] != '') {

        $sql = "UPDATE e_sistema_osteomuscular set 
...
`t198` = '" . $_REQUEST['t198'] . "' ,
`t199` = '" . $_REQUEST['t199'] . "' ,
`t200` = '" . $_REQUEST['t200'] . "' WHERE `id_e_sistema_osteomuscular` = '" . $_REQUEST['id_e_sistema_osteomuscular'] . "' ;";
    }

    $conexion->EjecutarQuery($sql);
}
$id_e_sistema_osteomuscular = 'new';
$sql = "SELECT * from e_sistema_osteomuscular WHERE `id_vinicial` = '" . $_REQUEST['id_vinicial'] . "' and `id_revaloracion` = '" . $_REQUEST['id_revaloracion'] . "' ";
$result = $conexion->EjecutarQuery($sql);
while ($row = mysql_fetch_array($result)) {
    $id_e_sistema_osteomuscular = $row['id_e_sistema_osteomuscular'];
...
<script>
    ...
    $(function() {
        ...
        $("#close-e_sistema_osteomuscular").click(function() {
            $("#open-e_sistema_osteomuscular").show();
            $(this).hide();
            $("#content-e_sistema_osteomuscular").hide('slow');
        });

        $("#open-e_sistema_osteomuscular").click(function() {
            $("#close-e_sistema_osteomuscular").show();
            $(this).hide();
            $("#content-e_sistema_osteomuscular").show('slow');
        });

    });

</script>
<fieldset id="e_sistema_osteomuscular">
    <legend align="left"> <div class="arrow-c" id="close-e_sistema_osteomuscular"></div> <div class="arrow-o" id="open-e_sistema_osteomuscular" ></div> <font>Valoracion fisioterapia de neurodesarrollo -  Evaluacion por sistemas</font></legend>
    <div id="content-e_sistema_osteomuscular">
        <?php
        if (isset($_REQUEST['id_cita'])) {
            $button = '<button name="guardar_e_sistema_osteomuscular" id="guardar_e_sistema_osteomuscular" >Guardar</button>';
        } else {
            $readonly = " readonly='readonly' ";
        }
        ?>
        <form id="form_e_sistema_osteomuscular" name="form_e_sistema_osteomuscular" action="<?php echo @$action_form_e_sistema_osteomuscular ?>#e_sistema_osteomuscular" method="post">

            <input type="hidden" id="id_e_sistema_osteomuscular" name="id_e_sistema_osteomuscular" value="<?php echo @$id_e_sistema_osteomuscular ?>" />
            <strong>B. Osteomuscular: </strong>
            ...
            <table border="0" class='data text_small' cellspacing="0" cellpadding="0" width="642">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" valign="center">Derecho</td>
                        <td></td>
                        <td></td>
                        <td colspan="2" valign="center"> Izquierdo</td>
                        <td colspan="2" valign="center">Derecho</td>
                        <td></td>
                        <td></td>
                        <td colspan="2" valign="center">Izquierdo</td>
                    ...
                    <tr>
                        ...
                        <td width="108" valign="top"><p align="center">Abduccion</p></td>
                        <td width="72" valign="top"><p align="center">0- 180</p></td>
                    ...
                    <tr>
                        ...
                        <td width="108" valign="top"><p align="center">Aduccion</p></td>
                    ...
                    <tr>
                        ...
                        <td width="108" valign="top"><p align="center">Abducción Vertical</p></td>
            ...
            <div>
                <table  class='data' border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td width="626" valign="top"><p>0    ninguna amplitud de movimiento sin gravedad y sin observarse ni palparse    contracción<br />
