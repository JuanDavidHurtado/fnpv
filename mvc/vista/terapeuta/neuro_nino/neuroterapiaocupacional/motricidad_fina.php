<?php
if (isset($_REQUEST['guardar_h2_sensopercepcion_nino1']) && isset($_REQUEST['id_cita'])) {
...
`senso_obser_2` = '" . $_REQUEST['senso_obser_2'] . "' WHERE `id_h2_sensopercepcion_nino` = '" . $_REQUEST['id_h2_sensopercepcion_nino'] . "' ;";
    }
...
<script>
    ...
    $(function() {
        ...
        $("#close-h2_sensopercepcion_nino1").click(function() {
            $("#open-h2_sensopercepcion_nino1").show();
            $(this).hide();
            $("#content-h2_sensopercepcion_nino1").hide('slow');
        });

        $("#open-h2_sensopercepcion_nino1").click(function() {
            $("#close-h2_sensopercepcion_nino1").show();
            $(this).hide();
            $("#content-h2_sensopercepcion_nino1").show('slow');
        });

    });

</script>
<fieldset id="h2_sensopercepcion_nino1">
    <legend align="left"> <div class="arrow-c" id="close-h2_sensopercepcion_nino1"></div> <div class="arrow-o" id="open-h2_sensopercepcion_nino1" ></div> <font>Valoracion terapia ocupacional de neurodesarrollo - Motricidad fina</font></legend>
    <div id="content-h2_sensopercepcion_nino1">
        <?php
        if (isset($_REQUEST['id_cita'])) {
            $button = '<button name="guardar_h2_sensopercepcion_nino1" id="guardar_h2_sensopercepcion_nino1" >Guardar</button>';
        } else {
            $readonly = " readonly='readonly' ";
        }
        ?>
        <form id="form_h2_sensopercepcion_nino1" name="form_h2_sensopercepcion_nino1" action="<?php echo @$action_form_h2_sensopercepcion_nino1 ?>#h2_sensopercepcion_nino1" method="post">
