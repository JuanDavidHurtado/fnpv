<?php
if (isset($_REQUEST['guardar_h2_sensopercepcion_nino']) && isset($_REQUEST['id_cita'])) {

    if ($_REQUEST['id_h2_sensopercepcion_nino'] == 'new') {

        $sql = "INSERT INTO h2_sensopercepcion_nino (
`id_h2_sensopercepcion_nino`,
`id_usuario`,
`historia`,
`id_proceso`,
`calor_p`,
...
'" . $_REQUEST['senso_obser1'] . "'
    ...
    } else if ($_REQUEST['id_h2_sensopercepcion_nino'] != '') {

        $sql = "UPDATE h2_sensopercepcion_nino set
...
`sv8` = '" . $_REQUEST['sv8'] . "' ,
`sv9` = '" . $_REQUEST['sv9'] . "' ,
`senso_obser1` = '" . $_REQUEST['senso_obser1'] . "'  WHERE `id_h2_sensopercepcion_nino` = '" . $_REQUEST['id_h2_sensopercepcion_nino'] . "' ;";
    }

    $conexion->EjecutarQuery($sql);
}
$id_h2_sensopercepcion_nino = 'new';
$sql = "SELECT * from h2_sensopercepcion_nino WHERE `id_vinicial` = '" . $_REQUEST['id_vinicial'] . "' and `id_revaloracion` = '" . $_REQUEST['id_revaloracion'] . "' ";
$result = $conexion->EjecutarQuery($sql);
while ($row = mysql_fetch_array($result)) {
    $id_h2_sensopercepcion_nino = $row['id_h2_sensopercepcion_nino'];
...
<script>
    ...
    $(function() {
        ...
        $("#close-h2_sensopercepcion_nino").click(function() {
            $("#open-h2_sensopercepcion_nino").show();
            $(this).hide();
            $("#content-h2_sensopercepcion_nino").hide('slow');
        });

        $("#open-h2_sensopercepcion_nino").click(function() {
            $("#close-h2_sensopercepcion_nino").show();
            $(this).hide();
            $("#content-h2_sensopercepcion_nino").show('slow');
        });

    });

</script>
<fieldset id="h2_sensopercepcion_nino">
    <legend align="left"> <div class="arrow-c" id="close-h2_sensopercepcion_nino"></div> <div class="arrow-o" id="open-h2_sensopercepcion_nino" ></div> <font>Valoracion terapia ocupacional de neurodesarrollo - Sensopercepcion</font></legend>
    <div id="content-h2_sensopercepcion_nino">
        <?php
        if (isset($_REQUEST['id_cita'])) {
            $button = '<button name="guardar_h2_sensopercepcion_nino" id="guardar_h2_sensopercepcion_nino" >Guardar</button>';
        } else {
            $readonly = " readonly='readonly' ";
        }
        ?>
        <form id="form_h2_sensopercepcion_nino" name="form_h2_sensopercepcion_nino" action="<?php echo @$action_form_h2_sensopercepcion_nino ?>#h2_sensopercepcion_nino" method="post">

            <input type="hidden" id="id_h2_sensopercepcion_nino" name="id_h2_sensopercepcion_nino" value="<?php echo @$id_h2_sensopercepcion_nino ?>" />

            <table  border="0" class="data" cellspacing="0" cellpadding="0" width="900">
                <tr>
            ...
            <p align="left"><strong>VESTIBULAR</strong></p>
            ...
            <p align="left"><strong>PROPIOCEPTIVO</strong></p>
            ...
            <table class="data " border="0" cellspacing="0" cellpadding="0" width="885">
                <tr>
                    <td width="116" valign="top"><p align="center"><strong></strong></p></td>
                ...
                <tr>
                    ...
                    <td width="81" valign="top">F</td>
                    <td width="72" valign="top">SF</td>
                    <td width="88" valign="top">NF</td>
                </tr>
                <tr>
            ...
            <br>
            <table  border="0" class="data" cellspacing="0" cellpadding="0" width="885">
                <tr>
