<?php
if (isset($_REQUEST['guardar_h2_cotidianidad_nino']) && isset($_REQUEST['id_cita'])) {

    if ($_REQUEST['id_h2_cotidianidad_nino'] == 'new') {

        $sql = "INSERT INTO h2_cotidianidad_nino (
`id_h2_cotidianidad_nino`,
`id_usuario`,
`historia`,
`id_proceso`,
`ute_1`,
...
'" . $_REQUEST['meses'] . "'
    ...
    } else if ($_REQUEST['id_h2_cotidianidad_nino'] != '') {

        $sql = "UPDATE h2_cotidianidad_nino set
...
`edad_moto` = '" . $_REQUEST['edad_moto'] . "' ,
`meses` = '" . $_REQUEST['meses'] . "' WHERE `id_h2_cotidianidad_nino` = '" . $_REQUEST['id_h2_cotidianidad_nino'] . "' ;";
    }

    $conexion->EjecutarQuery($sql);
}
$id_h2_cotidianidad_nino = 'new';
$sql = "SELECT * from h2_cotidianidad_nino WHERE `id_vinicial` = '" . $_REQUEST['id_vinicial'] . "' and `id_revaloracion` = '" . $_REQUEST['id_revaloracion'] . "' ";
$result = $conexion->EjecutarQuery($sql);
while ($row = mysql_fetch_array($result)) {
    $id_h2_cotidianidad_nino = $row['id_h2_cotidianidad_nino'];
...
<script>
    ...
    $(function() {
        ...
        $("#close-h2_cotidianidad_nino").click(function() {
            $("#open-h2_cotidianidad_nino").show();
            $(this).hide();
            $("#content-h2_cotidianidad_nino").hide('slow');
        });

        $("#open-h2_cotidianidad_nino").click(function() {
            $("#close-h2_cotidianidad_nino").show();
            $(this).hide();
            $("#content-h2_cotidianidad_nino").show('slow');
        });

    });

</script>
<fieldset id="h2_cotidianidad_nino">
    <legend align="left"> <div class="arrow-c" id="close-h2_cotidianidad_nino"></div> <div class="arrow-o" id="open-h2_cotidianidad_nino" ></div> <font>Valoracion terapia ocupacional de neurodesarrollo - Desempeño Ocupacional Realizante (DOR)</font></legend>
    <div id="content-h2_cotidianidad_nino">
        <?php
        if (isset($_REQUEST['id_cita'])) {
            $button = '<button name="guardar_h2_cotidianidad_nino" id="guardar_h2_cotidianidad_nino" >Guardar</button>';
        } else {
            $readonly = " readonly='readonly' ";
        }
        ?>
        <form id="form_h2_cotidianidad_nino" name="form_h2_cotidianidad_nino" action="<?php echo @$action_form_h2_cotidianidad_nino ?>#h2_cotidianidad_nino" method="post">

            <input type="hidden" id="id_h2_cotidianidad_nino" name="id_h2_cotidianidad_nino" value="<?php echo @$id_h2_cotidianidad_nino ?>" />

            <input type="hidden" class="input_txt valid" id="id_h2_cotidianidad_nino" name="id_h2_cotidianidad_nino" value="<?php echo @$id_h2_cotidianidad_nino; ?>" />
            <table  border="0" class="data" cellspacing="0" cellpadding="0" align="left">
                <tr>
            ...
            <table  border="0" class="data" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td width="47" valign="top"><p align="center">
            ...
            <p align="center"><strong>IMPRESIÓN DIAGNOSTICA</strong>:</p>
            <p align="center">
            ...
            <p><strong>EDAD MOTORA:</strong>                    (   
                <input type="text" class="input_txt valid" id="edad_moto" name="edad_moto" value="<?php echo @$edad_moto; ?>" />        
                )   AÑOS     (  
                <input type="text" class="input_txt valid" id="meses" name="meses" value="<?php echo @$meses; ?>" />  
                )  MESES<br />
            </p>
