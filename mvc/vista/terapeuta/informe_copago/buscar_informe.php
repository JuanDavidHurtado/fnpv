...
<div id="content_welcome">
    <br>
    <div class="welcome">
        Buscar reporte de Copagos
    </div>
    <br>

    <div id="text_welcome">
        <form name="form_user" id="form_user" action="index.php?option=mostrar_informe_c" method="post">
            ...
            <table border="0" cellpading="0" cellspacing="0">
                 ...
                 <tr>
                     <td width="56"><div align="left"><span>Usuario</span></div></td>
                            <td width="149">
                              <select id='id_usuario' class="input_txt " name='id_usuario' onchange="">
                 				   <option value='0' selected="selected">Todas</option>
                    		<?php
                    			//traer lista regimen

                                                $sqlnn = "select * from usuario where id_rol=4 or id_rol=1 order by nombre asc";
                                                $resultnn = $conexion->EjecutarQuery($sqlnn);
                                                while ($rownn = mysql_fetch_array($resultnn)) {

                                                    echo "<option value='" . $rownn['id_usuario'] . "' $style_s >" . $rownn['nombre'] ." ". $rownn['apeliido'] . "</option>";
                                                }
                    ?>
                </select>
                 </tr>
