...
<h3 align="center">HISTORIA CLINICA AGUDEZA VISUAL</h3>
<p align="center">
  <label></label>
</p>
<table width="693" border="0" align="center" cellpadding="0" cellspacing="0" class="data">
  <col width="165" />
  <col width="110" />
  <col width="185" />
  <col width="106" />
  ...
  <tr height="19">
    <td height="19" width="170">Cesarea</td>
    <td width="170"><input type="text" class="input_txt valid" id="cesarea" name="cesarea" value="<?php echo @$cesarea; ?>" /></td>
    <td width="185">Patológicos</td>
    <td width="168"><input type="text" class="input_txt valid" id="patologico" name="patologico" value="<?php echo @$patologico; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19" width="170">Apendice</td>
    <td width="170"><input type="text" class="input_txt valid" id="apendice" name="apendice" value="<?php echo @$apendice; ?>" /></td>
    <td width="185">Alérgicos    y Farmacolólogicos</td>
    <td width="168"><input type="text" class="input_txt valid" id="alergico" name="alergico" value="<?php echo @$alergico; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19" width="170">Vesicula</td>
    <td width="170"><input type="text" class="input_txt valid" id="vesicula" name="vesicula" value="<?php echo @$vesicula; ?>" /></td>
    <td colspan="2"><div align="center">PF</div></td>
  </tr>
  <tr height="19">
    <td height="19" width="170">Hernia</td>
    <td width="170"><input type="text" class="input_txt valid" id="hernia" name="hernia" value="<?php echo @$hernia; ?>" /></td>
    <td width="185">SI</td>
    <td width="168">NO</td>
  </tr>
  <tr height="19">
    <td height="19" width="170">Otro</td>
    <td width="170"><input type="text" class="input_txt valid" id="otro" name="otro" value="<?php echo @$otro; ?>" /></td>
    <td width="185"><input type="text" class="input_txt valid" id="pf_s" name="pf_s" value="<?php echo @$pf_s; ?>" /></td>
    <td width="168"><input type="text" class="input_txt valid" id="pf_n" name="pf_n" value="<?php echo @$pf_n; ?>" /></td>
  </tr>
  <tr height="19">
    <td colspan="4" height="19"><div align="center">Ginecologicos</div></td>
  </tr>
  <tr height="19">
    <td height="19" width="170">G </td>
    <td width="170">P</td>
    <td width="185">A </td>
    <td width="168">C</td>
  </tr>
  <tr height="19">
    <td height="19" width="170"><input type="text" class="input_txt valid" id="gine_g" name="gine_g" value="<?php echo @$gine_g; ?>" /></td>
    <td width="170"><input type="text" class="input_txt valid" id="gine_p" name="gine_p" value="<?php echo @$gine_p; ?>" /></td>
    <td width="185"><input type="text" class="input_txt valid" id="gine_a" name="gine_a" value="<?php echo @$gine_a; ?>" /></td>
    <td width="168"><input type="text" class="input_txt valid" id="gine__c" name="gine__c" value="<?php echo @$gine__c; ?>" /></td>
  </tr>
  <tr height="19">
