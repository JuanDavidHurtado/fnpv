...
if($row['estado']=='PROGRAMADO'){
  $sql = "update cita set estado='PROCESO' where id_cita = '{$_REQUEST['acc_c']}' ";
...
//if (true) {
    ...
    if (isset($_REQUEST['create'])) {
        $sql = "INSERT INTO  `valoracion_inicial_` (
            `id_valoracion_inicial_` ,
            `id_proceso` ,
            `historia` ,
            `id_usuario` ,
            `id_cita`,
    ...
    include(Utils::getFtpRuta() . 'mvc/vista/terapeuta/create_valoration_initial.php');
} else {
    ?>
    ...
    <div id="content_welcome" style="overflow-y:auto;" class="ui-tabs ui-widget ui-widget-content ui-corner-all">
        ...
        <h2>
            No tiene acceso a este modulo solicite permiso al Administrador.
        </h2>
