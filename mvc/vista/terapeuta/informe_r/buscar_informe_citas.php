...
<div id="content_welcome">
    ...
    <div id="text_welcome">
        <form name="form_user" id="form_user" action="index.php?option=mostrar_informe_r" method="post">

            <input type="hidden" value="<?php echo $hidden_val; ?>" name="type_acc" id="type_acc">
            <table border="0" cellpading="0" cellspacing="0">
               <tr>
                    <td width="56"  ><div align="left"><span > No generar reportes mayores a 10 dias !!</span></div></td></tr>
                 <tr>
