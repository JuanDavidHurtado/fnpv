<?php
if (isset($_REQUEST['guardar_ner_postural_anterior']) && isset($_REQUEST['id_cita'])) {

    if ($_REQUEST['id_ner_postural_anterior'] == 'new') {

        $sql = "INSERT INTO ner_postural_anterior (
`id_ner_postural_anterior`,
`id_usuario`,
`historia`,
`id_proceso`,
`fecha_plano_ant`,
...
'" . $_REQUEST['ppa8'] . "'
    ...
    } else if ($_REQUEST['id_ner_postural_anterior'] != '') {

        $sql = "UPDATE ner_postural_anterior set
...
`ppa6` = '" . $_REQUEST['ppa6'] . "' ,
`ppa7` = '" . $_REQUEST['ppa7'] . "' ,
`ppa8` = '" . $_REQUEST['ppa8'] . "' WHERE `id_ner_postural_anterior` = '" . $_REQUEST['id_ner_postural_anterior'] . "' ;";
    }

    $conexion->EjecutarQuery($sql);
}
$id_ner_postural_anterior = 'new';
$sql = "SELECT * from ner_postural_anterior WHERE `id_vinicial` = '" . $_REQUEST['id_vinicial'] . "' and `id_revaloracion` = '" . $_REQUEST['id_revaloracion'] . "'  ";
$result = $conexion->EjecutarQuery($sql);
while ($row = mysql_fetch_array($result)) {
    $id_ner_postural_anterior = $row['id_ner_postural_anterior'];
...
<script>
    ...
    $(function() {
        ...
        $("#close-ner_postural_anterior").click(function() {
            $("#open-ner_postural_anterior").show();
            $(this).hide();
            $("#content-ner_postural_anterior").hide('slow');
        });

        $("#open-ner_postural_anterior").click(function() {
            $("#close-ner_postural_anterior").show();
            $(this).hide();
            $("#content-ner_postural_anterior").show('slow');
        });

    });

</script>
<fieldset id="ner_postural_anterior">
    <legend align="left"> <div class="arrow-c" id="close-ner_postural_anterior"></div> <div class="arrow-o" id="open-ner_postural_anterior" ></div> <font>Valoracion fisioterapia de neurorehabilitacion - Examen postural plano anterior</font></legend>
    <div id="content-ner_postural_anterior">
        <?php
        if (isset($_REQUEST['id_cita'])) {
            $button = '<button name="guardar_ner_postural_anterior" id="guardar_ner_postural_anterior" >Guardar</button>';
        } else {
            $readonly = " readonly='readonly' ";
        }
        ?>
        <form id="form_ner_postural_anterior" name="form_ner_postural_anterior" action="<?php echo @$action_form_ner_postural_anterior ?>#ner_postural_anterior" method="post">

            <input type="hidden" id="id_ner_postural_anterior" name="id_ner_postural_anterior" value="<?php echo @$id_ner_postural_anterior ?>" />


            <input type="hidden" class="input_txt valid" id="id_ner_postural_anterior" name="id_ner_postural_anterior" value="<?php echo @$id_ner_postural_anterior; ?>" />


            <div id="content_long" style="width: 900px; height: auto;overflow-x: auto">
                <table  border="0" cellspacing="0" cellpadding="0" class="data" align="center">
                    <tr>
                        <td colspan="11"><br />
                            FECHA:
                    ...
                    <tr class='text_small'>
                        ...
                        <td width="38" valign="top">
                            <p>
                                <input type="text" class="input_txt valid" id="h2d" name="h2d" value="<?php echo @$h2d; ?>" /></p></td>
                        <td width="32" valign="top"><p>
