<?php
if (isset($_REQUEST['guardar_h2_patrones']) && isset($_REQUEST['id_cita'])) {
...
`patro_obser1` = '" . $_REQUEST['patro_obser1'] . "'  WHERE `id_h2_patrones` = '" . $_REQUEST['id_h2_patrones'] . "' ;";
    }
...
<script>
    ...
    $(function() {
        ...
        $("#close-h2_patrones").click(function() {
            $("#open-h2_patrones").show();
            $(this).hide();
            $("#content-h2_patrones").hide('slow');
        });

        $("#open-h2_patrones").click(function() {
            $("#close-h2_patrones").show();
            $(this).hide();
            $("#content-h2_patrones").show('slow');
        });

    });

</script>
<fieldset id="h2_patrones">
    <legend align="left"> <div class="arrow-c" id="close-h2_patrones"></div> <div class="arrow-o" id="open-h2_patrones" ></div> <font>Valoracion terapia ocupacional neurorehabilitacion - Patrones</font></legend>
    <div id="content-h2_patrones">
        <?php
        if (isset($_REQUEST['id_cita'])) {
            $button = '<button name="guardar_h2_patrones" id="guardar_h2_patrones" >Guardar</button>';
        } else {
            $readonly = " readonly='readonly' ";
        }
        ?>
        <form id="form_h2_patrones" name="form_h2_patrones" action="<?php echo @$action_form_h2_patrones ?>#h2_patrones" method="post">

            <input type="hidden" id="id_h2_patrones" name="id_h2_patrones" value="<?php echo @$id_h2_patrones ?>" />


            <input type="hidden" class="input_txt valid" id="id_h2_patrones" name="id_h2_patrones" value="<?php echo @$id_h2_patrones; ?>" />


            <p ><strong> PATRONES FUNCIONALES DE MOVIMIENTO</strong></p>
            <table  border="0" cellspacing="0" cellpadding="0" class="data" width="850">
                <tr>
