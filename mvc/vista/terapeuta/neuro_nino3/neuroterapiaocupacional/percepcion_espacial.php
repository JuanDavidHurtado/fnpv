<?php
if (isset($_REQUEST['guardar_h2_patrones_nino3']) && isset($_REQUEST['id_cita'])) {
...
`patro_obser4` = '" . $_REQUEST['patro_obser4'] . "'  WHERE `id_h2_patrones_nino` = '" . $_REQUEST['id_h2_patrones_nino'] . "' ;";
    }
...
<script>
    ...
    $(function() {
        ...
        $("#close-h2_patrones_nino3").click(function() {
            $("#open-h2_patrones_nino3").show();
            $(this).hide();
            $("#content-h2_patrones_nino3").hide('slow');
        });

        $("#open-h2_patrones_nino3").click(function() {
            $("#close-h2_patrones_nino3").show();
            $(this).hide();
            $("#content-h2_patrones_nino3").show('slow');
        });

    });

</script>
<fieldset id="h2_patrones_nino3">
    <legend align="left"> <div class="arrow-c" id="close-h2_patrones_nino3"></div> <div class="arrow-o" id="open-h2_patrones_nino3" ></div> <font>Valoracion terapia ocupacional de neurodesarrollo - Percepcion espacial</font></legend>
    <div id="content-h2_patrones_nino3">
<?php
if (isset($_REQUEST['id_cita'])) {
    $button = '<button name="guardar_h2_patrones_nino3" id="guardar_h2_patrones_nino3" >Guardar</button>';
} else {
    $readonly = " readonly='readonly' ";
}
?>
        <form id="form_h2_patrones_nino3" name="form_h2_patrones_nino3" action="<?php echo @$action_form_h2_patrones_nino3 ?>#h2_patrones_nino3" method="post">
