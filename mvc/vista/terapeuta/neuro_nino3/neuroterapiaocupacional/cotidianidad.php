...
$sql = "SELECT * from h2_cotidianidad_nino WHERE `historia` = '" . $_REQUEST['historia'] . "' and `id_revaloracion` = '" . $_REQUEST['id_revaloracion'] . "' ";
...
<fieldset id="h2_cotidianidad_nino">
    <legend align="left"> <div class="arrow-c" id="close-h2_cotidianidad_nino"></div> <div class="arrow-o" id="open-h2_cotidianidad_nino" ></div> <font>Valoracion terapia ocupacional de neurodesarrollo - Cotidianidad</font></legend>
