        ...
        if ($total_registros) {
            ...
            while ($row = mysql_fetch_array($resultados)) {
                ...
                echo "<tr class='$style_file_table'>
				 ...
				 <td align='center'><a href='?option=editar_formulas&identificacion=".$_REQUEST['identificacion']."&id_vinicial=".$id_inicial."&id_revaloracion=".$id_reinicial."&id_cita=".$id_cita."&id_usuario=".$id_usuario."&id_historia=".$id_historia."&id_fr_medicamentos=1'><img src='" . Utils::$http_ruta . "mvc/vista/imagenes/icon_edit.png' width='18px' height='18px' /></a></td>
