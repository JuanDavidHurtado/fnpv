...
<table cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="6" height="19" width="658">DETECCIÓN    TEMPRANA DE ALTERACIONES EN EL ADULTO MAYOR DE 45 AÑOS</td>
  </tr>
</table>
...
<p>&nbsp;</p>
<table width="831" border="1" align="center" cellpadding="0" cellspacing="0">
  <col width="171" />
  <col width="83" span="2" />
  <col width="113" />
  <col width="125" />
  <tr height="19">
    <td rowspan="2" height="38" width="154">SIGNOS    VITALES</td>
    <td width="168">TA</td>
    <td width="168">FC </td>
    <td width="168">FR</td>
    <td width="294">T°</td>
  ...
  <tr height="19">
    <td height="19"><input type="text" class="input_txt valid" id="sv_3_ta" name="sv_3_ta" value="<?php echo @$sv_3_ta; ?>" /></td>
    <td><input type="text" class="input_txt valid" id="sv_3_fc" name="sv_3_fc" value="<?php echo @$sv_3_fc; ?>" /></td>
    <td><input type="text" class="input_txt valid" id="sv_3_fr" name="sv_3_fr" value="<?php echo @$sv_3_fr; ?>" /></td>
    <td><input type="text" class="input_txt valid" id="t" name="t" value="<?php echo @$t; ?>" /></td>
  </tr>
  <tr height="19">
    <td rowspan="2" height="38">Valoración    nutricional</td>
    <td>Peso: </td>
  ...
  <tr height="19">
    <td height="19"><input type="text" class="input_txt valid" id="sv_3_pes" name="sv_3_pes" value="<?php echo @$sv_3_pes; ?>" /></td>
    <td><input type="text" class="input_txt valid" id="sv_3_talla" name="sv_3_talla" value="<?php echo @$sv_3_talla; ?>" /></td>
    <td colspan="2"><input type="text" class="input_txt valid" id="sv_3_imc" name="sv_3_imc" value="<?php echo @$sv_3_imc; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">Cabeza</td>
    <td colspan="4"><input type="text" class="input_txt valid" id="sv_3_cabeza" name="sv_3_cabeza" value="<?php echo @$sv_3_cabeza; ?>" /></td>
  </tr>
  <tr height="19">
    <td rowspan="2" height="38">Ojos</td>
    <td colspan="4">Agudeza Visual</td>
  ...
  <tr height="19">
    <td height="19">OD</td>
    <td><input type="text" class="input_txt valid" id="sv_3_ojosd" name="sv_3_ojosd" value="<?php echo @$sv_3_ojosd; ?>" /></td>
    <td>OI</td>
    <td><input type="text" class="input_txt valid" id="sv_3_ojosi" name="sv_3_ojosi" value="<?php echo @$sv_3_ojosi; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">Boca</td>
    <td colspan="4"><input type="text" class="input_txt valid" id="sv_3_boca" name="sv_3_boca" value="<?php echo @$sv_3_boca; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">ORL</td>
    <td colspan="4"><input type="text" class="input_txt valid" id="sv_3_orl" name="sv_3_orl" value="<?php echo @$sv_3_orl; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">Cuello</td>
    <td colspan="4"><input type="text" class="input_txt valid" id="sv_3_cuello" name="sv_3_cuello" value="<?php echo @$sv_3_cuello; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">Cardiopulmonar</td>
    <td colspan="4"><input type="text" class="input_txt valid" id="sv_3_cardio" name="sv_3_cardio" value="<?php echo @$sv_3_cardio; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">Mamas</td>
    <td colspan="4"><input type="text" class="input_txt valid" id="sv_3_mamas" name="sv_3_mamas" value="<?php echo @$sv_3_mamas; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">Abdomen</td>
    <td colspan="4"><input type="text" class="input_txt valid" id="sv_3_abdomen" name="sv_3_abdomen" value="<?php echo @$sv_3_abdomen; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">Genitourinario</td>
    <td colspan="4"><input type="text" class="input_txt valid" id="sv_3_genito" name="sv_3_genito" value="<?php echo @$sv_3_genito; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">Extremidades</td>
    <td colspan="4"><input type="text" class="input_txt valid" id="sv_3_extre" name="sv_3_extre" value="<?php echo @$sv_3_extre; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19">SNC</td>
    <td colspan="4"><input type="text" class="input_txt valid" id="sv_3_snc" name="sv_3_snc" value="<?php echo @$sv_3_snc; ?>" /></td>
  </tr>
  <tr height="19">
    <td height="19" width="154">CONDUCTA:</td>
    <td colspan="4"><input type="text" class="input_txt valid" id="sv_3_conduta" name="sv_3_conduta" value="<?php echo @$sv_3_conduta; ?>" /></td>
  </tr>
</table>
<?php echo @$button ?>
</form><br>
