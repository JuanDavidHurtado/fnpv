...
if($paso_con!=1){
    ...
    echo $dat.$tabla."<tr><td colspan='11' align='right'>TOTAL/PAGINA</td><td align='right'>".$total_co."</td><td align='right'>".$total_de."</td><td align='right'>".$total_f."</td><td align='right'>".$total_x."</td></tr>
