            ...
            <table border="0" cellpading="0" cellspacing="0">
              <tr>
                    ...
                    <td width="149">
					 ...
					 <tr>
                     <td width="56"><div align="left"><span>Tipo de contrato</span></div></td>
                            <td width="149">
                              <select id='id_contrato' class="input_txt " name='id_contrato' onchange="">
                 				   <option value='0' selected="selected">Todas</option>
                    		<?php
                    			//traer lista contrato

									$ret = '';
									$sqlr = "Select * from contrato";
									...
									while ($rowr = mysql_fetch_array($resultr)) {
										...
										echo "<option value='" . $rowr['id_contrato'] . "' $sel>" . $nombre_contrato . "</option>";
										$sel = "";
									}
                   			 ?>
                </select>
