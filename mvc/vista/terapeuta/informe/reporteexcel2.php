...
while($row2 = mysql_fetch_array($result3)) {
			 ...
			 $valor_consulta = $row2['valor_consulta'];; /////
			  $valor_cuota = 0; ////
                         ...
                         $fecha_factura = $row2['fecha_de_factura'];
 ...
 /*  $sql5 = "select SUM(copago) as total_reg from factura $where ";
        //$result215 = $conexion->EjecutarQuery($sql5);
        $result_nn=mysql_query($sql5,$IdConexion);
        $row215 = mysql_fetch_array($result215);
        $total_copago = $row215['total_reg'];*/

echo "<tr><td colspan='11' align='right'>TOTAL</td><td align='right'>".$total_co."</td><td align='right'>".$total_de."</td><td align='right'>".$total_f."</td><td align='right'>".$total_f1."</td></tr>";
