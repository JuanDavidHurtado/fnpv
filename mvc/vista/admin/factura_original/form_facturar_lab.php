    ...
    function agregarFila(obj) {
       ...
       if(total!=0&&id_eps!=0&&codigo!=""){
        ...
        limpiar();
            ...
            alert("Verifique que los campos(EPS,,Codigo,Cantidad) no estén vacios")
        }
...
<script type="text/javascript">
    ...
    function traer_valor22() {


        var codigo_cup = document.getElementById('id_cup_1').value;
      
        var parameters = "opcion=19&id_cup=" + codigo_cup;
    ...
    function traer_valor23() {


        var codigo_cup = document.getElementById('id_cup_2').value;
       
        var parameters = "opcion=18&id_cup=" + codigo_cup;
...
<form id="id_factura_formulario" action="?option=detalle_factura&origen=guardar" method="post">
    ...
    <table  height="24" border="1" align="center"   cellpadding="0" cellspacing="0">
        <tr>
            <td width="152" height="22">EPS</td>
            <td width="118"><select id='id_eps' class="input_txt " name='id_eps' >
          ...
          <td width="0"><div id="contrato_div"></div></td>
        </tr>
    </table>
<p>
...
<table width="673" border="1" align="center"  cellpadding="0" cellspacing="0" >
        ...
        <tr>
          ...
          <td ><input type="text" size="7px" name="id_cup_1" id="id_cup_1"  onchange="traer_valor22();"/></td>
            <td> 
                    <select id='id_cup_2' name='id_cup_2'class='input_txt' onchange="traer_valor23();">
                             <option value='0'>Seleccione</option>
                    <?php

                       $ret = "";
                                 $sql2 = "Select * from cups where origen=1";
                                 $result = $conexion->EjecutarQuery($sql2);
