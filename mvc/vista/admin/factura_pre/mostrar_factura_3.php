...
// datos del usuario
  ...
  //$where.=" and  date(fecha) between '2018-04-02' and '2018-04-02' ";
...
$hasta=37539;
  ...
  $where.=" and  date(fecha) between '2018-04-11' and '2018-04-16' ";
//$where.=" and  id_factura between '$desde' and '$hasta' ";

//traer los datos de la factura
$sql2 = "Select * from factura where estado =1 $where and id_eps=2";
...
<script type="text/javascript">
    ...
    function imprSelec2(nombre)
    {
        ...
        content += '<title>http://190.146.87.72/ridec </title>';
...
<div id="imprimir_factura">
  ...
  <table style="font-size: <?php echo $tamfont ?>px !important" width="750" border="0" class="data"  align="center" cellpadding="0" cellspacing="0">
        ...
        <tr height="">
            <td height=""><div align="center">RIDEC SAS
			</div></td>
        </tr>
        <tr height="">
        ...
        <tr height="">
            <td height=""><div align="center">Tel. 092-8339320</div></td>
        </tr>
        <tr height="">
            <td height=""><div align="center"><a href="mailto:administracion@siempree.com">ipsnuevapopayanut1@gmail.com</a></div></td>
        </tr>
        <tr height="">
            <td colspan="2" height="">Resoluci&oacute;n DIAN 18762007664218 abril 06 de 2018 numeracion desde FV 90124    hasta   FV 135120</td>
        </tr>
    </table>
    <table style="font-size: <?php echo $tamfont ?>px !important" width="750" border="0" class="data"  align="center" cellpadding="0" cellspacing="0">
	<tr>
