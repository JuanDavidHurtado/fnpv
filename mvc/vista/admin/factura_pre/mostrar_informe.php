...
//$where2=" where 1=1 ";
 ...
 $where2.="  where 1=1  and id_eps=51 and copago=0 ";
 ...
 if ($eps!=0) {
   ...
   // $where2.=" and  id_eps=$eps ";
    ...
    if($eps==51){
        $where="";
        $where.=" where 1=1  and id_eps=51 and copago=0";
        $where2="";
       $where2.="  where 1=1  and id_eps=51 and copago=0 ";
...
if($paso_con!=1){
     ...
     if($tipo_in==1){
        ...
        $sql5 = "select SUM(copago) as total_reg from factura  $where and estado=1 and copago<>0 and id_eps<>51 ";
        $result215 = $conexion->EjecutarQuery($sql5);
        $row215 = mysql_fetch_array($result215);
        $total_co = $row215['total_reg'];


        $sql55 = "select SUM(valor_total) as total_reg_2 from factura  $where2 and estado=1 and id_eps=51 and copago=0";
