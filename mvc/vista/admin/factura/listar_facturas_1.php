...
if (isset($_REQUEST['delete'])) {
    ...
    echo $sql2 = 'update  factura_cup set  tarifa=0,valor_t=0,fecha=0 ,cantidad=0  where id_factura = ' . $_REQUEST['acc'];
            ...
            while ($row = mysql_fetch_array($resultados)) {
                ...
                echo "<tr class='$style_file_table'>
                                ...
                                <td align='right'>" . $nombre_eps . "</td>
                                 ...
                                 <td align='center'><a href='?option=buscar_usuario&identificacion=".$_REQUEST['identificacion']."&origen=1&origen33=".$origen33."&id_factura=".$row['id_factura']."&id_cita=".$row['id_cita']."'><img src='" . Utils::$http_ruta . "mvc/vista/imagenes/icon_edit.png' width='18px' height='18px' /></a></td>
...
<br>
<br>
<a href='#' onClick='imprSelec("content_result")' >Imprimiiir</a>
</div>
