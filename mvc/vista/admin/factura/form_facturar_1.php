...
//copago
	...
	var numero1=parseFloat(stotal1) - parseFloat(v_copago) - parseFloat(des2);	

	
	var consulta = parseFloat(stotal1) - parseFloat(v_copago) - parseFloat(des2);
            ...
            // valor total
			document.getElementById('valort').value = numero1.toFixed(); 
          
            document.getElementById('consulta').value = consulta.toFixed();
    ...
    <table  height="52" border="1" align="center"   cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <tr>
            ...
            <td width="255" colspan="4" ><select id='id_medico' class="input_txt " name='id_medico'>
                    <option value='0'>Seleccione</option>
                    <?php
                    //traer lista eps
                   // $ep=$id_eps;
