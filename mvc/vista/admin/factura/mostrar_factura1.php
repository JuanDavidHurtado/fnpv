...
<script type="text/javascript">
    ...
    function imprSelec2(nombre)
    {
        ...
        content += '<title>http://190.146.87.72/UNICA </title>';
...
<div id="imprimir_factura">
    ...
    <table style="font-size: <?php echo $tamfont ?>px !important" width="750" border="0" class="data"  align="center" cellpadding="0" cellspacing="0">
        <tr >
            ...
            <td width="375"><div align="center">RADIOLOGÍA E IMÁGENES DIAGNOSTICAS DEL CAUCA</div></td>
            <td rowspan="8" width="156"><div align="center"><span class="Estilo5">Factura de venta N&deg; </span><br /> 
                    <span class="Estilo4">FV-<?php echo $idfactura2 ?> </span></div></td>
        </tr>
        <tr height="">
            <td height=""><div align="center">RIDEC SAS</div></td>
        </tr>
        <tr height="">
            <td height=""><div align="center">NIT:900800161-5</div></td>
        </tr>
        <tr height="">
            <td height=""><div align="center">Regimen Com&uacute;n</div></td>
        </tr>
        <tr height="">
            <td height=""><div align="center">Carrera 11# 13N-51 Santa Clara Popay&aacute;n(Cauca)</div></td>
        </tr>
        <tr height="">
            <td height=""><div align="center">Tel. 092-8201225-3186197223</div></td>
        </tr>
        <tr height="">
            <td height=""><div align="center"><a href="mailto:administracion@siempree.com">vipatri@gmail.com</a></div></td>
        </tr>
        <tr height="">
            <td colspan="2" height="">Resoluci&oacute;n DIAN 170000042541 Agosto 28 de 2015 numeracion desde FV 501    hasta  20000</td>
        </tr>
    </table>
    <table style="font-size: <?php echo $tamfont ?>px !important" width="750" border="0" class="data"  align="center" cellpadding="0" cellspacing="0">
	<tr>
    ...
    <table style="font-size: <?php echo $tamfont ?>px !important" border="0"  class="data"  align="center" width="750" cellpadding="0" cellspacing="0">
       ...
       // $sql_fac = "Select DISTINCT id_cup,nombre_cup,cantidad,tarifa,valor_t,cantidad from factura_cup where id_factura = " . $idfactura2." and fecha='".$fecha_factura_2."'";
	  ...
	  <td colspan='6'>Agendado por: <?php echo $agendador; ?></td>
        ...
        <tr height="">
            <td colspan="6" height=""><div align="center"><span class="Estilo2">Esta empresa esta amparada bajo la ley 1429 de 2010 de    formalizaci&oacute;n y generaci&oacute;n de empleo. T&iacute;tulo | art 2,4 y    siguientes.(Retefuente del 0%)</span></div></td>
        </tr>
    </table>
    <p>&nbsp;</p>
