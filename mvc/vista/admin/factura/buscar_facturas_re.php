...
<div id="content_welcome">
    ...
    <div id="text_welcome">
        <form name="form_user" id="form_user" action="index.php?option=listar_factura_re" method="post">
            <input type="hidden" value="<?php echo $hidden_val; ?>" name="type_acc" name="type_acc" />
            <input class="input_txt" type="hidden" name="origen" id="origen" value="11" />
             <input class="input_txt" type="hidden" name="origen33" id="origen33" value="1" />
