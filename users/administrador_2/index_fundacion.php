            ...
            <div id="content">
			 ...
			 <li class="li_line <?php echo $style_rip ?>">
                            ...
                            <li class="li_line <?php echo $style_factura ?>">
                                ...
                                <ul>
                                    <li>
                                        <a href="?option=busca_usuario_factura">Buscar Paciente</a>
                                    </li>
                                    <li>
                                        <a href="?option=factura_lab">Laboratorio</a>
                                    </li>
                                    <li>
                            ...
                            <li class="li_line <?php echo $style_nota ?>">
                                <a class="ali" href="?option=buscar_nota">Editar Nota adicional</a>
                            </li>
