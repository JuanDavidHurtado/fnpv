...
// historia
       ...
       case "mostrar_formulas":
        ...
        case "facturas_re_aux":
            $proceso_actual = 'FACTURA';
            $include = ("../../mvc/vista/admin/factura/buscar_facturas_re_1.php");
            $style_factura = "foco_menu";
            break;
         ...
         case "listar_factura":
            ...
            case "listar_factura_x":
            $proceso_actual = 'FACTURA';
            $include = ("../../mvc/vista/admin/factura/listar_facturas_x.php");
            $style_factura = "foco_menu";
            break;
          ...
          case "listar_factura_re_aux":
            $proceso_actual = 'FACTURA';
            $include = ("../../mvc/vista/admin/factura/listar_facturas_aux.php");
            $style_factura = "foco_menu";
            break;
         ...
         case "busca_usuario_factura":
            $proceso_actual = 'FACTURA';
            $include = ("../../mvc/vista/admin/factura/buscar_usuario_factura_1.php");
            $style_factura = "foco_menu";
            break;

               case "busca_usuario_factura_x":
            $proceso_actual = 'FACTURA';
            $include = ("../../mvc/vista/admin/factura/buscar_usuario_factura_1.php");
            $style_factura = "foco_menu";
            break;
                    ...
                    <div id="nav_prin">
                        <ul id="menu">
                            ...
                            <li class="li_line <?php echo $style_factura ?>">
                                ...
                                <ul>
                                    <li>
                                        <a href="?option=busca_usuario_factura_x">Facturar Paciente</a>
                                    </li>                                 
                                 ...
                                 <li>
                                     ...
                                     <li>
                                        <a href="?option=facturas_re_aux">Refacturar</a>
                                    </li>
                                </ul>
                            </li>
